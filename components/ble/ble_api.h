...
#define BLE_UUID_CONFIG_DEFAULT()                                                                 \
    {                                                                                             \
        0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0xEE, 0x00, 0x00, \
            0x00, 0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0xFF,   \
            0x00, 0x00, 0x00,                                                                     \
    }
...
#define BLE_ADV_DATA_CONFIG_DEFAULT()                                                              \
    {                                                                                              \
        ...
        .min_interval = 0x0006, .max_interval = 0x0010, .appearance = 0x00, .manufacturer_len = 0, \
        .p_manufacturer_data = NULL, .service_data_len = 0, .p_service_data = NULL,                \
        .service_uuid_len = sizeof(adv_service_uuid128), .p_service_uuid = adv_service_uuid128,    \
...
#define BLE_SCAN_RSP_DATA_CONFIG_DEFAULT()                                                       \
    {                                                                                            \
        .set_scan_rsp = true, .include_name = true, .include_txpower = true, .appearance = 0x00, \
